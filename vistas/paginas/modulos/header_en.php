			...
			<div class="row">
				...
				<div class="d-none d-lg-block col-lg-8 col-xl-6 p-0 pt-lg-2 mt-lg-1 pt-xl-4 botonera">
					...
					<ul class="nav justify-content-lg-left justify-content-xl-end">
						...
						<li class="nav-item">
							<a class="nav-link text-white" href="#cursos">courses</a>
						</li>

						<li class="nav-item">
							<a class="nav-link text-white" href="#nosotros">U.S</a>
						</li>

						<li class="nav-item">
							<a class="nav-link text-white" href="#testimonios">Testimonials</a>
						</li>

						<li class="nav-item">
							<a class="nav-link text-white" href="#planes">Plans</a>
						</li>
						...
						<li class="nav-item">
							<a class="nav-link text-white" href="#contactenos">Contact Us</a>
						</li>
				...
				<div class="col-5 col-sm-7 col-md-8 col-lg-2 col-xl-3 p-0 pt-4 pt-lg-2 mt-lg-1 pt-xl-4">
					...
					<div class="mr-2 mr-lg-0 float-right pt-1 ingresos">
						...
						<button class="btn btn-info btn-sm d-flex">
							...
							<a href="<?php echo $ruta; ?>ingreso" class="text-white">Pay in</a>

							<span class="text-white mx-2">|</span>

							<a href="<?php echo $ruta; ?>registro" class="text-white">Create Account</a>
